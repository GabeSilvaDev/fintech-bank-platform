...
sequenceDiagram
    ...
    alt R1 unknown, expired or family already revoked
        AS-->>GW: 401 INVALID_SESSION (nothing revoked)
        GW-->>C: 401 INVALID_SESSION, WWW-Authenticate Bearer
    else R1 active and family younger than REFRESH_FAMILY_MAX_AGE
    ...
    else R1 rotated or revoked, family past REFRESH_FAMILY_MAX_AGE, or the LWT lost
